...
$query="SELECT * FROM featuring WHERE id='$id'";
        ...
        <div class="col" >
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Update Featuring Product's </h3>
					...
					<div  id="settings">
                        ...
                        <div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
                                <img src="../../pics/featuring/<?php echo $row['image']; ?>" width="200px" height="200px"><br><br><br>
...
if(isset($_POST['update'])){
    ...
    $update="UPDATE featuring SET cattitle='$cattitle',subtitle='$subtitle',title='$title', description='$description', actualprice='$actualprice',discountprice='$discountprice',sellprice='$sellprice',image='$image' WHERE id='$id'";
    $updated=mysqli_query($conn,$update);
    if($updated){
        ?>
<script>
    window.location.href="http://projects.test/adminpanel/backend/feature_items/viewfeature.php";
    </script>    
    <?php
}
    else{
