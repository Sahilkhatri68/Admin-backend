        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                  <img  src="http://projects.test/adminpanel/backend/photos/<?php echo $data['image'] ;?>"
              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://projects.test/adminpanel/backend/trend/addtrend.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add  Hot-Trend's </p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://projects.test/adminpanel/backend/trend/viewtrend.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p> View  Hot-Trend's</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://projects.test/adminpanel/backend/best_seller/addseller.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add  Best-Seller's </p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://projects.test/adminpanel/backend/best_seller/viewseller.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p> View  Best-Seller's</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://projects.test//adminpanel/backend/feature_items/addfeature.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add   Features </p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://projects.test/adminpanel/backend/feature_items/viewfeature.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p> View   Features</p>
                                    </a>
                                </li>
