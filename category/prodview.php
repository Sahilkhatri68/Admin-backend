          ...
          <div class="card card-info">
            ...
            <div class="card-body p-0">
              <table class="table" >
                ...
                <?php
$select="SELECT category.id as catid,category.cattitle as catt,subcat.id as subcatid,subcat.cattitle as subb,product.* from product join category on category.id=product.cattitle join subcat on subcat.id=product.subtitle
";
                ...
                ?>
                  ...
                  <td><?php echo $row['id'];?></td>
                    ...
                    <td><?php echo $row['protitle']; ?></td>
                    <td><?php echo $row['prodescription'];?></td>
                    <td><?php echo $row['actualprice']; ?></td>
                    <td><?php echo $row['discount']; ?></td>
                    <td><?php echo $row['sellprice']; ?></td>

                    <td><img src="../photos/productimg/<?php echo $row['proimage']; ?> " width="100px" height="100px";>
