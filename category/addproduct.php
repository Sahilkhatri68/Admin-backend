...
if(isset($_POST['submit'])){ 
   ...
   $cattitle=$_POST['cattitle'];
	...
	$insert="INSERT  INTO  product(cattitle,subtitle,protitle,prodescription,actualprice,discount,sellprice,proimage)values('$cattitle','$subtitle','$protitle','$prodescription', '$actualprice','$discount','$sellprice','$proimage')";
  print_r($insert);
