...
$insert="INSERT INTO trend(cattitle,subtitle,title,description,actualprice,discountprice,sellprice,image) VALUES('$cattitle','$subtitle','$title','$description','$actualprice','$discount','$sellprice','$image')";
// print_r($insert);
        ...
        <div class="col-md-12">
          <div class="card card-primary" >
            <div class="card-header">
              <h3 class="card-title" >Add Hot-trend's </h3>
