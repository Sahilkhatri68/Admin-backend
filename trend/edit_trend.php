        ...
        <div class="col" >
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Update Hot-Trend's </h3>
					...
					<div  id="settings">
						<form class="form-horizontal" method="POST" enctype="multipart/form-data"id="myform">
								<div class="form-group row">
									...
									<div class="col-sm-10">
									  <input type="text"  class="form-control" name="title" value="<?php echo $row['title']; ?>" id="inputName">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
                                <img src="../photos/trending/<?php echo $row['image']; ?>"><br><br><br>
...
if(isset($_POST['update'])){
    ...
    $update="UPDATE trend SET title='$title', description='$description', image='$image' WHERE id='$id'";
    $updated=mysqli_query($conn,$update);
    if($updated){
        ?>
<script>
    window.location.href="http://projects.test/adminpanel/backend/trend/viewtrend.php";
    </script>    
    <?php
}
    else{
